...
TRACK_LIBRARY: dict[str, list[dict]] = {
    ...
    "train_right_rect_a": track_from_centers([
        [2.4, -0.1, 1.4],
        [-0.4, 2.4, 1.6],
        [2.5, 5.1, 1.5],
        [5.2, 2.6, 1.4],
    ], radius=0.72),
    "train_right_rect_b": track_from_centers([
        [2.8, -0.3, 1.6],
        [-0.7, 2.5, 1.4],
        [2.3, 5.4, 1.8],
        [5.7, 2.4, 1.3],
    ], radius=0.70),
    "train_right_lowhigh": track_from_centers([
        [2.3, 0.0, 1.0],
        [-0.6, 2.3, 1.9],
        [2.6, 5.2, 1.2],
        [5.4, 2.4, 2.0],
    ], radius=0.66),
    "train_right_switchback": track_from_centers([
        [2.0, 0.6, 1.1],
        [-1.0, 2.2, 1.9],
        [2.1, 5.7, 1.2],
        [5.8, 2.0, 2.0],
    ], radius=0.63),
    "train_long_hex_a": track_from_centers([
        [2.4, -0.5, 1.3],
        [5.4, 0.8, 1.7],
        [5.9, 3.4, 1.5],
        [3.1, 5.9, 1.8],
    ...
    "train_long_hex_b": track_from_centers([
        [2.0, -0.4, 1.1],
        [5.0, 0.7, 1.9],
        [6.1, 3.1, 1.3],
        [3.5, 6.0, 1.7],
    ...
    "train_long_snake": track_from_centers([
        [2.2, -0.6, 1.2],
        [5.8, 0.9, 1.9],
        [3.8, 2.8, 1.0],
        [5.9, 4.8, 2.0],
    ...
    "heldout_right_diamond": track_from_centers([
        [2.5, -0.1, 1.5],
        [0.0, 2.3, 1.7],
        [2.4, 4.8, 1.4],
        [5.1, 2.1, 1.8],
    ], radius=0.70),
    "heldout_right_tilted": track_from_centers([
        [2.1, 0.5, 1.2],
        [-0.8, 2.7, 1.8],
        [2.3, 5.5, 1.4],
        [4.9, 2.6, 1.9],
    ], radius=0.67),
    "heldout_right_lowhigh": track_from_centers([
        [2.4, -0.2, 0.9],
        [-0.6, 2.5, 2.0],
        [2.7, 5.4, 1.1],
        [5.6, 2.7, 2.1],
    ], radius=0.64),
    "heldout_long_hex": track_from_centers([
        [2.3, -0.7, 1.2],
        [5.2, 0.6, 1.9],
        [6.0, 3.3, 1.4],
        [3.6, 6.1, 1.8],
    ...
    "heldout_long_hex_right": track_from_centers([
        [2.5, -0.6, 1.4],
        [-0.9, 1.9, 1.8],
        [0.3, 5.1, 1.1],
        [3.4, 6.0, 1.9],
    ...
    "heldout_long_snake": track_from_centers([
        [2.0, -0.7, 1.0],
        [5.7, 0.7, 2.0],
        [3.9, 2.8, 1.0],
        [6.1, 4.8, 2.1],
    ...
    "heldout_long_snake_right": track_from_centers([
        [2.3, -0.5, 1.2],
        [-1.1, 2.8, 1.8],
        [2.0, 6.0, 1.0],
        [5.8, 4.9, 2.1],
